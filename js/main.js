...
(function($){
    site = {
        ...
        spreadsheet: function(){
            // Messages are loaded inline via js/messages.js (var TWC_MESSAGES), so the
            // site renders straight from the filesystem with no server. The data is
            // generated by build.py from data/messages.csv.
            var json = TWC_MESSAGES;
            site.messages = json;
            site.buildFeed(json);
            site.probe();
            console.log('go');
